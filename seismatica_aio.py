...
if __name__ == '__main__':
    ...
    if cfg['plot_control'] == 'True':
        ...
        for i in range(1, len(waveforms)+1):
            ...
            plt.plot(t_c, waveforms_c[i-1][1], 'k', alpha = 0.75)
            plt.ylabel(waveforms_c[i-1][0], fontsize = 16)
        ...
        for i in range(1, len(ent)+1):
            ...
            plt.ylabel(waveforms[i-1][0], fontsize = 16)
        ...
        plt.ylabel(r'$\bf{H}$', fontsize = 16, rotation = 90)
        plt.grid(True)
        plt.subplot(2, 1, 2)
        plt.plot(H_cont, 'k', alpha = 0.75)
        plt.xlabel(r'Counts $\it{i}$', fontsize = 16)
        plt.ylabel(r'$\bf{C}$', fontsize = 16, rotation = 90)
        plt.xticks(fontsize = 12)
        plt.yticks(fontsize = 12)    
        plt.grid(True)
        plt.tight_layout()
